...
"use strict";
__webpack_require__.r(__webpack_exports__);
var checkArea = function checkArea() {
...
/* harmony default export */ __webpack_exports__["default"] = (checkArea);
...
/* harmony import */ var _server_server__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../server/server */ "./src/js/server/server.js");
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_server_server__WEBPACK_IMPORTED_MODULE_4__["postData"])('assets/server.php', formData).then(function (res) {
        console.log(res);
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _checkArea__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkArea */ "./src/js/modules/checkArea.js");
...
var modals = function modals() {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (e.target.classList.contains('popup_calc_button')) {
          if (Object(_checkArea__WEBPACK_IMPORTED_MODULE_1__["default"])()) {
            return;
          }
        }
  ...
  var showModalByTime = setTimeout(function () {
    document.querySelector('.main_popap').style.display = 'block';
    document.body.style.overflow = 'hidden';
  }, 60000);
...
var timer = function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      days.textContent = t.days < 10 ? "0".concat(t.days) : t.days;
      hours.textContent = t.hours < 10 ? "0".concat(t.hours) : t.hours;
      minutes.textContent = t.minutes < 10 ? "0".concat(t.minutes) : t.minutes;
      seconds.textContent = t.seconds < 10 ? "0".concat(t.seconds) : t.seconds;
